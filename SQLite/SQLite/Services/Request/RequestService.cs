namespace SQLite.Services.Request
{
    using Exceptions;
    ...
    public class RequestService : IRequestService
    {
        ...
        HttpClient CreateHttpClient(string token = "")
        {
            ...
            httpClient.DefaultRequestHeaders.Authorization = IsEmail(token) ? new AuthenticationHeaderValue("Email", token) : new AuthenticationHeaderValue("Bearer", token);

            return httpClient;
        }

        bool IsEmail(string email) => true;
